...
import { ResidentWeightIntelligence } from "@/components/weight/ResidentWeightIntelligence";
...
export function ObservationHistory({ residentId }: { residentId: string }) {
  ...
  return <div className="space-y-4">
    {(type === "all" || type === "weight" || type === "bmi") && <ResidentWeightIntelligence residentId={residentId} />}
