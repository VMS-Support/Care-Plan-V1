...
export const assessmentMeta: Record<AssessmentType, AssessmentMeta> = {
  ...
  stratify_falls: { name: "STRATIFY Falls Assessment Tool", description: "Draft — Clinical Source Required", category: "Falls and Mobility", template: clinicalSourceRequired("Approved STRATIFY source required, including the transfer/mobility risk rule and risk threshold.") },
  personal_emergency_evacuation_plan: { name: "Personal Emergency Evacuation Plan", shortName: "PEEP", description: "Draft — Clinical Source Required", category: "Emergency Planning and Evacuation", template: clinicalSourceRequired("Approved Personal Emergency Evacuation Plan form and applicable fire-safety guidance required.") },
  bed_rail_assessment_hse: { name: "Bed Rail Assessment", description: "Draft — Clinical Source Required", category: "Safety, Equipment and Restrictive Practice", template: { ...clinicalSourceRequired("Current organisation-approved HSE bed-rail assessment form required."), sourceAuthorOrOrganisation: "Health Service Executive (HSE)" } },
  a_key_to_me: { name: "A Key to Me", description: "Draft — Clinical Source Required", category: "Person-Centred Care and Communication", template: clinicalSourceRequired("Approved A Key to Me form required.") },
  baseline_continence: { name: "Baseline Continence", description: "Draft — Clinical Source Required", category: "Continence", template: clinicalSourceRequired("Approved Baseline Continence form required.") },
  continence_assessment: { name: "Continence Assessment", description: "Draft — Clinical Source Required", category: "Continence", template: clinicalSourceRequired("Approved Continence Assessment form required.") },
  medley_assessment_tool: { name: "MEDLEY Assessment Tool", description: "Draft — Clinical Source Required", category: "Clinical category pending source verification", template: clinicalSourceRequired("Approved MEDLEY Assessment Tool source, purpose, version and licensing status required.") },
};
