...
export const currentRoleTemplateCapabilities: Record<CurrentRoleKey, Permission[]> = {
  HCA: [
    ...
    "maintenance.work_orders.view", "maintenance.work_orders.create", "maintenance.work_orders.view_reported_own",
    "maintenance.work_orders.view_assigned",
    "maintenance.work_orders.assign_self", "maintenance.work_orders.accept", "maintenance.work_orders.start",
    "maintenance.work_orders.pause", "maintenance.work_orders.await_parts", "maintenance.work_orders.await_contractor",
    "maintenance.work_orders.await_access", "maintenance.work_orders.resume",
  ...
  CNM: [
    ...
    "home_assignments.view", "home_assignments.view_fte", "home_assignments.view_history", "ward_competency_requirements.view", "ward_competency_requirements.view_matrix", "ward_competency_requirements.view_readiness", "staffing_establishment.view", "staffing_establishment.view_actuals", "staffing_establishment.view_vacancies", "staffing_establishment.view_fte",
  ],
  DON: [
    "maintenance.contractors.overview.view", "maintenance.contractors.register.view", "maintenance.contractors.view",
    "maintenance.contractors.create", "maintenance.contractors.edit", "maintenance.contractors.activate", "maintenance.contractors.deactivate", "maintenance.contractors.suspend", "maintenance.contractors.reactivate", "maintenance.contractors.archive", "maintenance.contractors.restore",
    "maintenance.contractors.contacts.view", "maintenance.contractors.contacts.create", "maintenance.contractors.contacts.edit", "maintenance.contractors.contacts.deactivate", "maintenance.contractors.contacts.archive", "maintenance.contractors.contacts.set_primary", "maintenance.contractors.contacts.set_emergency",
    "maintenance.contractors.service_areas.view", "maintenance.contractors.service_areas.create", "maintenance.contractors.service_areas.edit", "maintenance.contractors.service_areas.activate", "maintenance.contractors.service_areas.deactivate", "maintenance.contractors.service_areas.archive",
    "maintenance.contractors.homes.view", "maintenance.contractors.homes.create", "maintenance.contractors.homes.edit", "maintenance.contractors.homes.activate", "maintenance.contractors.homes.restrict", "maintenance.contractors.homes.suspend", "maintenance.contractors.homes.deactivate", "maintenance.contractors.homes.archive",
    "maintenance.contractors.notes.view", "maintenance.contractors.notes.create", "maintenance.contractors.notes.edit", "maintenance.contractors.notes.pin", "maintenance.contractors.notes.remove", "maintenance.contractors.notes.restricted.view", "maintenance.contractors.timeline.view", "maintenance.contractors.audit.view", "maintenance.contractors.dashboard.view",
    ...
    "home_assignments.view", "home_assignments.create", "home_assignments.edit", "home_assignments.set_primary", "home_assignments.suspend", "home_assignments.end", "home_assignments.cancel", "home_assignments.enter_in_error", "home_assignments.view_fte", "home_assignments.edit_fte", "home_assignments.view_history", "ward_competency_requirements.view", "ward_competency_requirements.create", "ward_competency_requirements.edit", "ward_competency_requirements.view_matrix", "ward_competency_requirements.view_readiness", "staffing_establishment.view", "staffing_establishment.create_draft", "staffing_establishment.edit_draft", "staffing_establishment.submit_approval", "staffing_establishment.approve", "staffing_establishment.supersede", "staffing_establishment.retire", "staffing_establishment.enter_in_error", "staffing_establishment.view_actuals", "staffing_establishment.view_vacancies", "staffing_establishment.view_fte", "staffing_establishment.view_budget_reference",
  ],
  GROUP_OWNER: [
    ...
    "home_assignments.view", "home_assignments.view_all_homes", "home_assignments.create", "home_assignments.edit", "home_assignments.set_primary", "home_assignments.suspend", "home_assignments.end", "home_assignments.cancel", "home_assignments.enter_in_error", "home_assignments.view_fte", "home_assignments.edit_fte", "home_assignments.view_history", "ward_competency_requirements.view", "ward_competency_requirements.create", "ward_competency_requirements.edit", "ward_competency_requirements.view_matrix", "ward_competency_requirements.view_readiness", "staffing_establishment.view", "staffing_establishment.view_all_homes", "staffing_establishment.create_draft", "staffing_establishment.edit_draft", "staffing_establishment.submit_approval", "staffing_establishment.approve", "staffing_establishment.supersede", "staffing_establishment.retire", "staffing_establishment.enter_in_error", "staffing_establishment.view_actuals", "staffing_establishment.view_vacancies", "staffing_establishment.view_fte", "staffing_establishment.view_budget_reference",
    "maintenance.work_orders.view", "maintenance.work_orders.create", "maintenance.work_orders.edit",
    "maintenance.work_orders.view_all_for_home", "maintenance.work_orders.view_assigned",
    "maintenance.work_orders.view_reported_own", "maintenance.work_orders.view_archived",
    "maintenance.work_orders.assign", "maintenance.work_orders.assign_self",
